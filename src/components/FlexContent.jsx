    ...
    <>
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-900 fiter drop-shadow-lg ">
            {title}
          </h1>
        ...
        <div className="flex items-center justify-center max-w-xl relative lg:max-w-none w-full">
          <img
            src={img}
            alt={`img/${heading}`}
            className={`w-auto object-fill transition-theme lg:mt-3 ${
              ifExists
                ? "h-60 lg:h-56 md:h-52 sm:h-44 mxs:h-36 rotate-6 hover:-rotate-12"
