          ...
          <ul className="flex items-center justify-center gap-2">
            ...
            <li className="grid items-center">
              ...
              >
                ...
                />
                <div
                  className={`absolute top-4 right-0 w-4 h-4 text-[0.65rem] leadign-tight font-medium rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-all duration-300 ${
                    navState
