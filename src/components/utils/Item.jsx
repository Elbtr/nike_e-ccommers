    ...
    <>
      <div
        className={`relative bg-gradient-to-b ${color} ${shadow} grid items-center  ${
          ifExists ? "justify-start" : "justify-items-center"
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between w-28 my-2 cursor-default">
            ...
            <div className="flex items-center gap-1">
              ...
              <h1 className="md:text-sm font-medium text-slate-100">
                {rating}
              </h1>
            </div>
          </div>
